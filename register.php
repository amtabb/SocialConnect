...
<html>
<head>
	<title>Welcome to Social Connect..!!</title>
			...
			<div id="first">
				...
				<form action="register.php" method="POST">
					...
					if(isset($_GET['blocked'])){
						echo '<p style="color:red;">Your account is disabled.</p><br/>';
					}
					...
					<br/>
					<a href="admin/login.php"  class="signup">Are you an admin? Login Here</a>
