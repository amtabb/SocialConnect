...
if(isset($_GET['profile_username'])) {
	...
	$username = $_GET['profile_username']; // To get the username from the url passed using .htaccess file

	$user_details_query = mysqli_query($con, "SELECT * FROM users WHERE username='$username'"); // Query to get the details of user
...
if(isset($_POST['post_message'])) {
 ...
 ?>
    ...
    <!-- Profile left -- profile pic section -->

 		<img src="<?php echo $user_array['profile_pic']; ?>">

    <!-- Display's info of user on profile left section -->
    ...
    <!-- To redirect to user_closed.php if user is closed -->
